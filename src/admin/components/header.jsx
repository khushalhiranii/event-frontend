...
const Header = ({
  ...
  return (
    <div
      className={`no-print fixed h-[68px] z-40 bg-white flex flex-row items-center justify-between py-boundvariablesdata10 px-boundvariablesdata5 text-left text-[0.75rem] text-white font-semibold border-b-[1px] border-solid border-black-10 ${className}`}
