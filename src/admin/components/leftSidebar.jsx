...
const Sidebar = ({ className = "" }) => {
  ...
  return (  
<div
      className={`fixed h-full overflow-y-auto bg-white left-[0rem] box-border w-[15.25rem] flex flex-col items-start justify-start p-[1rem] gap-[0.5rem] text-left text-base text-black-100 font-normal border-r-[1px] border-solid border-black-10 ${className} `}
    >
