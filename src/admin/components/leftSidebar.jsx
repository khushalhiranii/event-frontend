...
const Sidebar = ({ className = "" }) => {
  ...
  return (  
<div
      className={`fixed overflow-y-auto top-[0.25rem] left-[0rem] box-border w-[15.25rem] flex flex-col items-center justify-start p-[1rem] gap-[0.5rem] text-left text-[0.875rem] text-black-100 font-semibold border-r-[1px] border-solid border-black-10 ${className} `}
      style={headerStyle}
    >
