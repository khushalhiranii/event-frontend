...
const TodoForm = ({ todos = [], onSubmit }) => {
  ...
  const [todo, setTodo] = useState({ image: '', eventName: '', isPaid: false, city: '', eventDate:'', userJourney: ["Attendance", "Food", "Kit"], eventTemplate: '', attendieType: ["Audience","NRI","Speaker"], address: '' });
