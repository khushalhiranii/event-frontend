...
const TodoForm = ({ todos = [], onSubmit }) => {
  ...
  const [todo, setTodo] = useState({ image: '', eventName: '', isPaid: false, city: '', eventDate:'', userJourney: ["Attendance"], eventTemplate: '', attendieType: ["Audience","NRI","Speaker"], address: '' });
