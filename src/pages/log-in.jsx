...
const LogIn = () => {
  ...
  return (
    <div className="w-full top-[calc(50%_-_269px)] flex flex-row justify-around relative bg-white h-full py-12 overflow-hidden text-center text-[2rem] text-black1 font-h3-32-bold mq450:flex-col  mq675:flex-col">
